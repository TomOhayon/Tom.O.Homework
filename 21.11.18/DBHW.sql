...
SELECT vehicles.veh_reg_no , vehicles.brand , customers.name , rental_records.start_date , rental_records.end_date from vehicles , customers , rental_records
order by vehicles.veh_reg_no , vehicles.brand , rental_records.start_date;

SELECT vehicles.veh_reg_no , customers.name , rental_records.start_date , rental_records.end_date from vehicles , customers , rental_records
where rental_records.start_date <  '2012-01-10' and rental_records.end_date >  '2012-01-10' 
order by vehicles.veh_reg_no , vehicles.brand , rental_records.start_date;

SELECT vehicles.veh_reg_no , vehicles.brand, vehicles.desc , rental_records.start_date , rental_records.end_date from vehicles , rental_records
where rental_records.start_date <=  '2012-01-03' and rental_records.end_date >=  '2012-01-18' 
order by vehicles.veh_reg_no , vehicles.brand , vehicles.desc , rental_records.start_date;

SELECT vehicles.veh_reg_no , vehicles.brand, vehicles.desc , rental_records.start_date , rental_records.end_date from vehicles , rental_records
where  rental_records.start_date >  '2012-01-10' or rental_records.end_date < '2012-01-10'
order by vehicles.veh_reg_no , vehicles.brand , vehicles.desc , rental_records.start_date;
